...
def test_prepare_data(bert_data_module):
...
def test_truncation(bert_data_module):
...
def test_tokenization(bert_data_module):
...
def test_setup(bert_data_module):
    # Create a dummy dataset for testing
    dataset = load_dataset('glue', "sst2")
...
def test_split_data(bert_data_module):
    # Create a dummy dataset for testing
    dataset = load_dataset('glue', "sst2")
    bert_data_module.dataset = dataset
...
def test_train_dataloader(bert_data_module):
...
def test_val_dataloader(bert_data_module):
